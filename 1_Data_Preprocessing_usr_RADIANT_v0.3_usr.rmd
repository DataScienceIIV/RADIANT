---
title: "1_Data_Preprocessing_RADIANT.V0.3_usr"
...
# importing custom functions
  RMD = "Pre_processing"
  versionRMD = "v0.3"
  source(file.path(wd, cellType, "00 RADIANT files", "RADIANT_dependencies_usr_v0.3.R"))
  versionCheck()
...
# a = raw files, b = transformed files, c = cleaned and transformed files 
  ...
  write.ArcsinH.Mapping = TRUE # set to TRUE if you want a panel file template to be written automatically
  ashPer = "date" # indicate if you want to write one arcsinh mapping file for all samples, or  per batch. Valid entries are "global" and "date"
...
### ADJUSTABLE VARIABLES ###
  ...
  writePanel = TRUE # set to TRUE if you want to write the Panel file
  
  performCompAID = TRUE # set to TRUE if you want to perform compensAID
  plotCompAID = FALSE # set to TRUE if you want to plot the compensAID results
  maxCells = 50000 # set to the maximum number of cells you want to plot for compensAID results. Can also be set to "All"
  ...
  markers_of_interest = c("FSC-A", "SSC-A", "CD8_IgG", "CD123", "CCR7", "CD14_CD24_TCRgd", "PD1", "CD21", "CD127_IgA_IgG2_IgG3", "CXCR5", "CXCR3", "CD19", "CD11c", "CD56", "CD95", "IgM_IgG4_TCRva72_TCRvd2", "CD45RA", "CCR6", "CD57", "CD31", "CD4_CD20", "CD3_IgD_IgG1_IgG3", "HLA_DR", "CD27", "CCR4", "CD16", "CCR10", "CD38", "KLRG1", "CD25") 
...
"Blue2-610_20-A" = "CD123",
"Blue3-670_30-A" = "CCR7",
"Blue4-710_50-A" = "CD14_CD24_TCRgd",
"Blue5-750_30-A" = "PD1",
"Blue6-810_40-A" = "CD21",
"Red1-670_30-A" = "CD127_IgA_IgG2_IgG3",
"Red2-710_50-A" = "CXCR5",
"Red3-780_60-A" = "CXCR3",
"UV1-379_28-A" = "CD19",
"UV3-515_30-A" = "CD11c",
"UV4-580_20-A" = "CD56",
"UV5-610_20-A" = "CD95",
"UV6-670_30-A" = "IgM_IgG4_TCRva72_TCRvd2",
"UV7-740_35-A" = "CD45RA",
"UV8-810_40-A" = "CCR6",
"Violet1-450_50-A" = "CD57",
"Violet2-525_50-A" = "CD31",
"Violet3-585_15-A" = "CD4_CD20",
"Violet4-610_20-A" = "CD3_IgD_IgG1_IgG3",
"Violet5-670_30-A" = "HLA_DR",
"Violet6-710_50-A" = "CD27",
"Violet7-750_30-A" = "CCR4",
"Violet8-810_40-A" = "CD16",
"YG1-586_15-A" = "CCR10",
"YG2-610_20-A" = "CD38",
"YG4-710_50-A" = "KLRG1",
"YG5-780_60-A" = "CD25"
